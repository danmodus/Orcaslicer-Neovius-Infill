...
PRINT_CONFIG_CLASS_DEFINE(
    ...
    ((ConfigOptionFloat, brim_object_gap))((ConfigOptionEnum<BrimType>, brim_type))((ConfigOptionFloat, brim_width))(
        (ConfigOptionFloat, brim_ears_detection_length))((ConfigOptionFloat, brim_ears_max_angle))((ConfigOptionFloat, skirt_start_angle))(
        (ConfigOptionBool, bridge_no_support))((ConfigOptionFloat, elefant_foot_compensation))((
...
PRINT_CONFIG_CLASS_DEFINE(
    ...
    // Orca: flow ratios
    ((ConfigOptionBool, set_other_flow_ratios))((ConfigOptionFloat, first_layer_flow_ratio))((ConfigOptionFloat, outer_wall_flow_ratio))((
        ConfigOptionFloat, inner_wall_flow_ratio))((ConfigOptionFloat, overhang_flow_ratio))((ConfigOptionFloat, sparse_infill_flow_ratio))(
...
PRINT_CONFIG_CLASS_DEFINE(
    ...
    // BBS
    ((ConfigOptionBool, scan_first_layer))((ConfigOptionBool, enable_power_loss_recovery))((ConfigOptionBool, enable_wrapping_detection))(
    ...
    ((ConfigOptionEnumsGeneric, z_hop_types))((ConfigOptionFloats, travel_slope))((ConfigOptionFloats, retract_lift_above))(
        ...
        (ConfigOptionFloats, retraction_speed))((ConfigOptionString, machine_start_gcode))((ConfigOptionStrings, filament_start_gcode))(
        (ConfigOptionBool, single_extruder_multi_material))((ConfigOptionBool, manual_filament_change))((
        ConfigOptionBool, single_extruder_multi_material_priming))((ConfigOptionBool, wipe_tower_no_sparse_layers))((ConfigOptionString,
...
PRINT_CONFIG_CLASS_DERIVED_DEFINE(
    ...
    ((ConfigOptionFloats, wipe_tower_x))((ConfigOptionFloats, wipe_tower_y))((ConfigOptionFloat, prime_tower_width))(
        ...
        ConfigOptionBool, prime_tower_skip_points))((ConfigOptionBool, prime_tower_flat_ironing))((ConfigOptionFloat, wipe_tower_bridging))(
